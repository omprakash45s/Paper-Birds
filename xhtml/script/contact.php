<?php
/*
Template Name: Paper Bird Shishukul - Education Primary School For Children
...
$dzEmailFrom    = "Paper Bird Shishukul Contact";
...
try {
    if (!empty($_POST)) {
		...
		$dzMailSubject = 'Paper Bird Shishukul|Contact Form: A Person want to contact';
		$dzMailMessage	= 	"
