						...
						<div className="main-bar clearfix ">
							<div className="container clearfix">
								...
								<div className="header-nav navbar-collapse collapse myNavbar justify-content-end" id="navbarNavDropdown">
									...
									<li><Link to={"./"} style={{color:"#ff564b"}}>Home</Link></li>
									<li><Link to={"/about-1"} style={{color:"#ffb02d"}}>About Us</Link></li>
									<li><Link to={"/classes"} style={{color:"#cfd92f"}}>Classes</Link></li>
									<li><Link to={"/teachers"} style={{color:"#00bbc0"}}>Teachers</Link></li>
										...
										<li><Link to={"/gallery-masonary"} style={{color:"#ffb02d"}}>Gallery</Link></li>
										<li><Link to={"/careers"} style={{color:"#28a745"}}>Careers</Link></li>
										<li><Link to={"/contact-us"} style={{color:"#473b79"}}>Contact Us</Link></li>
									</ul>		
								</div>
							</div>
						</div>
