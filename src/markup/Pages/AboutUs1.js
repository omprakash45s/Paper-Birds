...
import gallery2 from "./../../images/gallery/imgg.png";
                ...
                <div className="row align-items-center">
                  ...
                  <div className="col-lg-6 col-md-12 col-sm-12 m-b15">
                    <div className="section-head">
                      ...
                      >
                        <p>
                          For more than a decade, I have been a part of the
                          education system, and my journey into early childhood
                          education began with a deep love for children and a
                          desire to create something meaningful for them. When I
                          envisioned this preschool, I wanted it to feel like a
                          second home—safe, warm, and emotionally
                          comforting—where every child is supported, understood,
                          and free to grow at their own pace.
                        </p>
                        <p>
                          Over the years, I have had the privilege of guiding
                          more than 590 families, standing beside parents
                          through every stage of their child's early
                          development. This experience has strengthened my
                          belief that the foundation we lay in these tender
                          years shapes a child's confidence, curiosity, and
                          overall well-being.
                        </p>
                        <p>
                          I have poured my heart and soul into building a
                          preschool environment that celebrates each child's
                          individuality and nurtures their natural desire to
                          explore. My deep admiration for Dr. Maria Montessori's
                          philosophy continues to guide our approach, ensuring
                          that every child experiences the joy of self-directed
                          learning, independence, and discovery.
                        </p>
                        <p>
                          It is my commitment to create a space where children
                          feel loved, protected, and inspired every single day.
                          Thank you for trusting us with the most precious part
                          of your lives.
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="split-box">
                      <div className="about-media">
                        <img
                          ...
                          style={{
                            width: "100%",
                            border: "4px solid #48af53",
                            borderRadius: "20px",
                            boxShadow: "0 10px 40px rgba(72, 175, 83, 0.2)",
                            objectFit: "cover",
                          }}
                        />
                      </div>
    ...
    >
      ...
      <p>
        ...
        endless possibilities.
                ...
                <div className="row m-t60 align-items-center">
                  <div className="col-lg-7 col-md-12 m-b30">
                    <div className="section-head">
                      ...
                      {/* Uniform Font Style Applied Here */}
                      <div
                        style={{
                          fontSize: "16px",
                          lineHeight: "1.8",
                      ...
                      >
                        <p>
                          Latha Rao is the current director of training of IMTC
                          (Indian Montessori Training Courses) Koramangala under
                          the auspices of the Indian Montessori Centre. She is
                          passionate about creating learning environments for
                          children that help them learn with joy.
                        </p>
                        <p>
                          She has done her primary course from Association
                          Montessori Internationale and elementary course from
                          Indian Montessori Centre. She has also worked in Anne
                          Frank Montessori in Long Island, NY under the teachers
                          exchange programme and worked with children for more
                          than 30 years, including the Valley School of the KFI
                          institutions.
                        </p>
                        <p>
                          As a science graduate from the University of Madras,
                          she has done her Masters in inclusive education from
                          the University of Northampton, UK. Her latest learning
                          has been an in-depth study of curating Montessori
                          environments to integrate children with learning
                          differences. This certificate is in collaboration with
                          the Maria Montessori Institute, London.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="m-t80" style={{ marginBottom: "60px" }}>
                  <div className="section-head text-center m-b50">
                    ...
                    <p style={{ fontSize: "18px", color: "#666" }}>
                      Bringing world-class Montessori education to your
                      neighborhood
                    </p>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-6 col-md-12 m-b30">
                      <div
                        ...
                        onMouseEnter={(e) => {
                          ...
                          e.currentTarget.style.boxShadow =
                            "0 20px 40px rgba(72, 175, 83, 0.15)";
                        }}
                        onMouseLeave={(e) => {
                      ...
                      >
                        ...
                        >
                          The heart of Paper Bird Shishukul. Located on the
                          serene Paramahansa Yogananda Road, our Indiranagar
                          campus has been setting the benchmark for early
                          childhood education for over 8 years. It is here that
                          our legacy of warmth, care, and academic excellence
                          began, serving hundreds of happy families in the
                          community.
                        </p>
                    ...
                    <div className="col-lg-6 col-md-12 m-b30">
                      <div
                        ...
                        onMouseEnter={(e) => {
                          e.currentTarget.style.transform = "translateY(-10px)";
                          e.currentTarget.style.boxShadow =
                            "0 20px 40px rgba(24, 119, 242, 0.15)";
                        }}
                        onMouseLeave={(e) => {
                          e.currentTarget.style.transform = "translateY(0)";
                          e.currentTarget.style.boxShadow =
                      ...
                      >
                        <div
                          style={{
                            ...
                            right: "20px",
                            background:
                              "linear-gradient(135deg, #ff564b 0%, #ff8e84 100%)",
                            color: "#fff",
                            padding: "5px 15px",
                            borderRadius: "30px",
                            fontSize: "12px",
                        ...
                        >
                          We are thrilled to bring the Paper Bird Shishukul
                          philosophy to Whitefield! Our newest campus is a
                          state-of-the-art facility designed to provide the same
                          home-like environment, premium Montessori
                          infrastructure, and dedicated care that parents have
                          trusted for years. A fresh beginning for your little
                          one's journey.
                        </p>
        ...
        {/* Footer Moved Outside Page Content */}
        <Footer />
      </Fragment>
    );
  }
